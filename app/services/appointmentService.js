...
const sendBookEmail = async (patientId, doctorId, savedAppointment, res) => {
  ...
  let urlD = `https://nexus-frontend-rho.vercel.app/doctor/waitlist`;
  let urlP = `https://nexus-frontend-rho.vercel.app/patient/dashboard`;
...
const sendApproveEmail = async (doctorId, appointment, res) => {
  ...
  const doctor = await getDoctorById(doctorId);
  let urlP = `https://nexus-frontend-rho.vercel.app/patient/messages`;
...
const sendCancelEmail = async (appointment, res) => {
  ...
  let history = `https://nexus-frontend-rho.vercel.app/patient/history`;
  let history2 = `https://nexus-frontend-rho.vercel.app/doctor/history`;
...
const sendRescheduleEmail = async (appointment, res) => {
  const patient = await getPatientById(appointment.patientId);
  const doctor = await getDoctorById(appointment.doctorId);
  let urlP = `https://nexus-frontend-rho.vercel.app/doctor/messages`;
  let urlD = `https://nexus-frontend-rho.vercel.app/patient/messages`;
